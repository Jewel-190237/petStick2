...
const LookingFor = () => {
  return (
    <div className="bg-[#FFE6E4]">
      <div className="pet-container py-16">
          ...
          {lookingForData.map((item) => (
            <div key={item._id} className="text-center">
              ...
              <div className="max-w-[230px] mx-auto">
                <h1 className="text-textMain hover:text-primary font-bold text-[28px] font-laila mb-4">
                  {item.heading}
                </h1>
                <p className="text-[16px] text-textBody font-lora">
                  {item.description}
                </p>
              </div>
            </div>
