...
const Hero = () => {
    return (
        <div className="flex gap-14 bg-[url('/home1/hero/bg.svg')] bg-cover bg-no-repeat bg-center py-16 px-8 h-[650px] md:h-[700px] lg:h-[988px] -mt-32 overflow-hidden">
            <div className='max-w-[1320px] mx-auto flex w-full'>
                <div className="max-w-[750px] flex flex-col justify-center space-y-6">
                    <h1 className="hero-heading">Established & Trusted Pet Care Service</h1>
