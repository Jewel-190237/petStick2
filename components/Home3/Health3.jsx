...
const Health3 = () => {
  ...
  const [selectedItem, setSelectedItem] = useState({
    ...
    image: "/home1/Health/person1.svg",
  });
  ...
  return (
    <div className="pet-container mt-20 flex flex-col sm:flex-row-reverse sm:gap-5 md:gap-6 lg:gap-16 xl:gap-20 items-center bg-white health-shadow rounded-[40px]">
        ...
        <div className="mt-7 lg:mt-8 xl:mt-10 flex flex-col gap-4 w-full lg:w-[80%]">
          {currentData.map((data, index) => (
            <div key={index} className="flex items-center ">
              ...
              <label
                htmlFor={`radio-${index}`}
                className="cursor-pointer heading2 !font-medium p-3"
              >
                {data.item}
              </label>
            </div>
