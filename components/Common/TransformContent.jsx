    ...
    >
      ...
      <div className="pet-container absolute inset-0 flex items-center justify-center">
        <div className="mx-auto ">
          <h1 className="heading1 !leading-[110%] text-center text-white w-full lg:w-[60%] mx-auto">
            {heading}
          </h1>
          <p className="description mt-4 lg:mt-6 text-white text-center w-full lg:w-[60%] mx-auto">
            {description}{" "}
          </p>
          <div className="flex justify-center items-center">
            <Link href='/adoption'>
              <button className="pet-button mt-8 md:mt-10 lg:mt-12 xl:mt-14">
                Adoption
              </button>
            </Link>
          </div>
